...
const LanguageToggle: React.FC = () => {
  ...
  const toggleLanguage = useCallback((): void => {
    const newLang: LanguageCode = i18n.language === "pt-BR" ? "en-US" : "pt-BR";
  ...
  return (
    <button
      ...
      aria-label={isPortuguese ? "Mudar para Inglês" : "Switch to Portuguese"}
      title={isPortuguese ? "English" : "Português"}
    >
      {isPortuguese ? (
        // US Flag (English)
        <svg
        ...
        >
          ...
          <g clipPath="url(#s)">
            ...
            <path
              d="M0,3.5 h60 M0,7 h60 M0,10.5 h60 M0,14 h60 M0,17.5 h60 M0,21 h60 M0,24.5 h60 M0,28 h60"
              stroke="#fff"
              strokeWidth="2.5"
            />
              ...
              <g id="c">
                <g id="e">
                  <g id="b">
                    <path
                      id="a"
                      d="M3,1.5 l0.3,0.9 h0.9 l-0.7,0.5 l0.3,0.9 l-0.7-0.5 l-0.7,0.5 l0.3-0.9 l-0.7-0.5 h0.9 z"
                    />
                    <use xlinkHref="#a" y="6" />
                  </g>
                  <use xlinkHref="#b" x="6" />
      ...
      <span className={styles.langText}>{isPortuguese ? "EN" : "PT"}</span>
    </button>
  );
};
